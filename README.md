...
## قاعدة الكلمات والأمثلة السياقية

تضم النسخة الحالية 213 كلمة وعبارة إملائية تعليمية موزعة على 11 تصنيفًا. ترتبط الكلمات بـ46 مثالًا سياقيًا مزدوجًا يعرض الجملة قبل التصحيح وبعده، إضافة إلى 20 جملة صحيحة للتدريب. تستخدم المراجعة اليومية ومحاكاة الساعة هذه الأمثلة بالتناوب، مع إبقاء التصحيح قائمًا على محاولة المستخدم أولًا.
