...
import { createWatchQuestions } from '../utils/practice';
...
export function WatchPage() {
  ...
  const watchQuestions = useMemo(() => {
    const queued = Object.values(state.progress.words)
      .filter((word) => word.watchQueued)
    ...
    return createWatchQuestions([...queued, ...spellingErrors]);
